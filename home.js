...
let footerDesCtn;
let footerDes =
  "I diritti non sono solo quelli riconosciuti dalla legge. Ci sono azioni che tutti mettiamo in atto, ed è questo ciò che li legittima. </br> Mentire, distruggere, fallire, dimenticare, copiare. Sono comportamenti sbagliati, o è la nostra percezione ad esserlo?</br> </br> INATTO è una rivista indipendente scritta da creativi per creativi con l'obiettivo di aprire una discussione sulle esigenze di coloro che appartengono a questo settore. </br> La testata è la legislazione mentre ogni numero è un nuovo diritto, legittimato attraverso le parole delle persone che hanno contribuito alla creazione rivista stessa. </br>Il magazine si propone come luogo di dialogo tra punti di vista diversi, con il fine di mettere in discussione quei tabù che impediscono al sistema creativo di evolversi. </br></br>Il magazine è un progetto universitario sviluppato nel corso del Laboratorio di Progettazione di sistemi e artefatti complessi C1 della Laurea Magistrale in Design della Comunicazione del Politecnico di Milano. Il corso punta a riflettere sul valore sociale dell'editoria indipendente. Il macrotema è la collaborazione, mentre il sottotema sono i diritti. </br></br>";
let footerTxt = [
  {
